...
# Define trend data sources
def get_google_trends():
    """Get Google Trends fallback data."""
    return [
        {
...
def get_reddit_trends():
    """Get Reddit Trends fallback data."""
    return [
        {
            "title": "Scientists discover new planet with habitable conditions",
            "subreddit": "science",
            "score": 92,
            "comments": 3254,
        ...
        {
            "title": "New documentary about AI sparks debate",
        ...
        {
            "title": "People are rediscovering this 90s sitcom",
        ...
        {
            "title": "Interactive map shows global temperature changes",
        ...
        {
            "title": "The versatile work blazer trending this summer",
        ...
        default_trends = [
            {
                ...
                "pop_potential": True,
                "notes": "Eco-friendly and sustainable clothing options are gaining significant traction."
            },
            {
                "trend_name": "Home Workout Equipment",
                "source": "Market Analysis",
                "category": "Fitness",
                "lifecycle_stage": "Mature",
                "pop_potential": True,
                "notes": "Home gym equipment continues to be popular post-pandemic."
            },
            {
                "trend_name": "NFT Art Collections",
                "source": "Tech News",
                "category": "Digital",
                "lifecycle_stage": "Declining",
                "pop_potential": False,
                "notes": "Interest in NFT art appears to be waning after initial boom."
            }
        ]
        
        with open('data/manual_trends.json', 'w') as file:
            json.dump(default_trends, file, indent=2)
        
        return default_trends

@app.route('/')
def index():
    """Main dashboard with all trends."""
    try:
...
# Apply any other routes as needed
